...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -0.19566159236273975; // y position of the parallel encoder (in tick units)
        public double perpXTicks =  0.10023236191308892; // x position of the perpendicular encoder (in tick units)
    }
