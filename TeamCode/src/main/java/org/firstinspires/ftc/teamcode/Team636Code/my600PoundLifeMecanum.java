...
public class my600PoundLifeMecanum extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addLine("good luck people!");
        telemetry.update();
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.left_bumper && motorLinearSlides2.getCurrentPosition() > -3700) {
                motorLinearSlides1.setPower(-gamepad2.left_stick_y);
                motorLinearSlides2.setPower(gamepad2.left_stick_y);
            }
            telemetry.addData("Ethan Position", motorLinearSlides1.getCurrentPosition());
            telemetry.addData("Jamal Position", motorLinearSlides2.getCurrentPosition());
