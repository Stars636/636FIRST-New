...
public class PIDCalc {
    ...
    public PIDCalc(double p, double i, double d){
        ki = i;
        kd = d;
        kp = p;
        this.correctJitter = false;
    }
    public PIDCalc(double p, double i, double d, boolean correctJitter){
        ki = i;
        kd = d;
        kp = p;
        this.correctJitter = correctJitter;
    }
    public PIDCalc(double p, double i, double d, boolean correctJitter, boolean distanceSensor){
